      ...
      <div className="ml-auto flex items-center gap-2">
        <div className="relative">
          <input
            ...
            className="w-[280px] sm:w-[320px] rounded-xl pl-9 pr-8 py-2 text-sm ring-1 ring-slate-200 focus:ring-2 focus:ring-indigo-400 outline-none bg-white"
          ...
          {tabs.map((t) => {
            ...
            return (
              <button
                ...
                className={`relative z-9 px-3 py-1.5 font-semibold transition-colors ${

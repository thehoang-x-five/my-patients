...
const LOCALIZED_LABELS = {
  ...
  da_ke: { vi: "Chờ phát", en: "Waiting dispense" },
  ...
  hen_phe_quan: { vi: "Hen phế quản", en: "Asthma" },
  tang_huyet_ap: { vi: "Tăng huyết áp", en: "Hypertension" },
  mo_mau_cao: { vi: "Mỡ máu cao", en: "High blood lipids" },
  dai_thao_duong: { vi: "Đái tháo đường", en: "Diabetes" },
  tieu_duong: { vi: "Tiểu đường", en: "Diabetes" },
  tim_mach: { vi: "Bệnh tim mạch", en: "Cardiovascular disease" },
  benh_tim_mach: { vi: "Bệnh tim mạch", en: "Cardiovascular disease" },
  gout: { vi: "Gout", en: "Gout" },
  suy_than: { vi: "Suy thận", en: "Kidney failure" },
  benh_than: { vi: "Bệnh thận", en: "Kidney disease" },
  viem_gan_b: { vi: "Viêm gan B", en: "Hepatitis B" },
  viem_gan_c: { vi: "Viêm gan C", en: "Hepatitis C" },
  roi_loan_mo_mau: { vi: "Rối loạn mỡ máu", en: "Dyslipidemia" },
